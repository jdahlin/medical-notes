...
### Koppling till banor
- Motorneuron → [[PNS|perifera nerver]] → motorändplattor.  
- Sensoriska neuron → posteriora rötter → ascendenta banor som lemniscus medialis och spinothalamiska banan.  
- Interneuron → lokala reflexbågar och modulering av [[Afferens efferens integration|integration]] i ryggmärg och hjärna.
